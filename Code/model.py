import psycopg2
con = psycopg2.connect(database="toiletDB", host="localhost", user="postgres", password="292001", port=5432)
cur = con.cursor()
...
sql_location = "CREATE TABLE tbllocation(locationid integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 ), PRIMARY KEY(locationid), \
    location character varying(150),\
    longitude real,\
    latitude real)"
